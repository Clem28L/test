...
# Load images
RED_SPACE_SHIP = pygame.image.load(os.path.join("Invader.png"))
RED_SPACE_SHIP = pygame.transform.scale(RED_SPACE_SHIP, (100, 100))
# Player player
YELLOW_SPACE_SHIP = pygame.image.load(os.path.join("space-invaders.png"))
...
# Background
BG = pygame.transform.scale(pygame.image.load(os.path.join("Sky_with_stars.png")), (WIDTH, HEIGHT))
...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("Vous avez perdu !", 1, (255,255,255))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Cliquez pour commencer", 1, (255,255,255))
